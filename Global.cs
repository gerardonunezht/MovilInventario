...
namespace InventarioCL
{
   ...
   /// <param name="pPIID"></param>
   /// <returns></returns>
        public bool ValidaLocalizacionInventario(string pLocalizacion, string pPIID)
        {
            ...
            if (pLocalizacion == "")
            {
                MessageBox.Show("Localizacion no valida..", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1);  
                return false;
            }
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = cn;            
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Localizacion no encontrada..", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1);
                    return false;
                }
            }
            catch (Exception ex)
                    ...
                    if (dt != null)
                    {
                        if (dt.Tables.Count > 0)
                        {
                            if (dt.Tables[0].Rows.Count > 0)
                            {
                                ...
                                {
                                    //MessageBox.Show("Conteo registrado.");
                                }
                                else
                                {
