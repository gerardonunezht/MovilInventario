...
namespace InventarioCL
{
    public class Global
    {
        ...
        public Global()
        {
            ...
            db = new AccesoDatos(Properties.Resources.cn);
        }

        /// <summary>
        /// Verifica si la cadena corresponde a un dato numerico
        /// </summary>
         ...
         public string defualt_siteid()
        {
         ...
         public bool ValidaLocalizacionInventarioArticulo(string pLocalizacion, string pPIID, string pClave)
         {
             //intra_InventarioVerificarLocalizacionArticulo
             //@PIID varchar(50),
             ...
             if (pLocalizacion == "")
             {
                 MessageBox.Show("Localizacion/Clave no valida.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1);
                 return false;
             }
             Dictionary<string, object> Parametros = new Dictionary<string, object>();
             Parametros.Add("@Localizacion", pLocalizacion);
             Parametros.Add("@PIID", pPIID);
             Parametros.Add("@Clave", pClave);

             //SqlCommand cmd = new SqlCommand();
             //cmd.Connection = cn;
             //cmd.CommandType = CommandType.StoredProcedure;
             //cmd.CommandText = "intra_InventarioVerificarLocalizacionArticulo";
             ...
             try
             {
                 DataTable dt=db.ExecuteSelect("intra_InventarioVerificarLocalizacionArticulo", Parametros);
                 DataRow row=dt.Rows[0];
                 int tot = 0;
                 tot = Convert.ToInt16(row[0].ToString());
        ...
        /// <summary>
        /// Obtiene los datos del usuario si esta registrado en el inventario.
        /// </summary>
        /// <param name="pSiteid">Almacén</param>
        /// <param name="pPIID">Inventario</param>
        /// <param name="pIdpareja">Número de usuario</param>
        /// <returns></returns>
         public DataSet Datos_Pareja(string pSiteid, string pPIID, string pIdpareja)
         {
             Dictionary<string, object> Parametros = new Dictionary<string, object>();
             Parametros.Add("@SiteID", pSiteid);
             Parametros.Add("@PIID", pPIID);
             Parametros.Add("@Pareja_No", pIdpareja);
             return db.ExecuteSelect("intra_Inventario_Datos_Pareja_Inventario", Parametros).DataSet;
         }
        //{
        ...
        //    }
        //}
        public DataSet ObtenerDatosArticuloCB(string pCB)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.Connection = cn;
            SqlDataAdapter da = new SqlDataAdapter();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "intra_InventarioObtenerArticuloCodigoBarras";
            cmd.Parameters.AddWithValue("@CodigoBarras", pCB);
            da.SelectCommand = cmd;
            DataSet dt = new DataSet();
            try
            {
        ...
        public void ActualizaStatus(string pPareja_no, string pPIID, string pSiteId)
        {
            Dictionary<string, object> Parametros = new Dictionary<string, object>();
            Parametros.Add("@SiteID", pSiteId);
            Parametros.Add("@PIID", pPIID);
            Parametros.Add("@Pareja_No", int.Parse(pPareja_no));
            db.ExecuteUpdate("intra_Inventario_Actualiza_Status_Inventario", Parametros);
        }
        ...
        //    cmd.CommandText = "intra_Inventario_Actualiza_Status_Inventario";
        //    cmd.Parameters.AddWithValue("@Pareja_No", int.Parse(pPareja_no));
        //    cmd.Parameters.AddWithValue("@PIID", pPIID);
        //    cmd.Parameters.AddWithValue("@SiteID", pSiteId);
        ...
        //    catch (Exception ex)
        //    {
        //        MessageBox.Show("Error en inicio/cierre de sesión.." + ex.Message.ToString());
        ...
        /// </summary>
        /// <returns></returns>
        public DataSet lista_almacenes_activos()
        {
            return db.ExecuteSelect("intra_Inventario_Lista_Almacenes_Activos").DataSet;
        }
        ...
        //    DataSet dt = new DataSet();
        //    cmd.CommandType = CommandType.StoredProcedure;
        //    cmd.CommandText = "intra_Inventario_Lista_Almacenes_Activos";
        //    da.SelectCommand = cmd;           
        //    try
        //    {
        //        da.Fill(dt);
        ...
        /// <summary>
        /// Obtiene los inventarios activos de acuerdo al ALMACEN
        /// </summary>
        /// <param name="siteid">Almacén seleccionado</param>
        /// <returns>Datos de los inventarios activos</returns>
        public DataSet lista_inventarios(string siteid)
        {
            Dictionary<string, object> Parametros = new Dictionary<string, object>();
            Parametros.Add("@SiteID", siteid);
            return db.ExecuteSelect("intra_Inventario_Activo", Parametros).DataSet;
        }
        //{
       ...
       /// <summary>
       /// Validar la localizacion del inventario especificado
       /// </summary>
       /// <param name="pLocalizacion">Localizacion</param>
       /// <param name="pPIID">Inventario</param>
       /// <returns>Verdadero si el usuario puede registrar conteo</returns>
        public int ValidaLocalizacionInventario(string pLocalizacion, string pPIID)
        {
            //intra_InventarioVerificarLocalizacion
            //@PIID varchar(50),
            //@Localizacion VARCHAR(50)

            if (pLocalizacion == "")
            {
                MessageBox.Show("Teclee o escanee una localización..", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1);  
                
            }
            Dictionary<string, object> Parametros = new Dictionary<string, object>();
            Parametros.Add("@PIID", pPIID);
            Parametros.Add("@Localizacion", pLocalizacion);
            Parametros.Add("@NoPareja", Global.pareja_no);
            try
            {
                DataRow row = db.ExecuteSelect("intra_InventarioVerificarLocalizacion", Parametros).Rows[0];
                int tot = Convert.ToInt16(row[0].ToString());
                return tot;
            }
            catch (Exception)
            {
            ...
            //cmd.Connection = cn;            
            //cmd.CommandType = CommandType.StoredProcedure;
            //cmd.CommandText = "intra_InventarioVerificarLocalizacion";
            //cmd.Parameters.AddWithValue("@Localizacion", pLocalizacion);
            //cmd.Parameters.AddWithValue("@PIID", pPIID);
            //cmd.Parameters.AddWithValue("@NoPareja",Global.pareja_no);
            //try
            //{
            //    if (cn.State == ConnectionState.Closed)
            //    {
        ...
        /// <summary>
        /// Obtiene los datos del marbete en la localizacion especificada
        /// </summary>
        /// <param name="pLocalizacion"></param>
        /// <param name="pPIID"></param>
        /// <returns></returns>
        public DataSet ObtenerMarbeteLocalizacion(string pLocalizacion, string pPIID, string pCodigo)
        {            
            //Intra_Inventario_Obtener_Marbete_Localizacion	    
            //@PIID varchar(50),
            //@Localizacion VARCHAR(50)
            //@Codigo VARCHAR(50)
            if (pLocalizacion == "")
            ...
            //SqlDataAdapter da = new SqlDataAdapter();
            //cmd.CommandType = CommandType.StoredProcedure;
            //cmd.CommandText = "Intra_Inventario_Obtener_Marbete_Localizacion_Articulo";           
            //cmd.Parameters.AddWithValue("@PIID", pPIID);
            //cmd.Parameters.AddWithValue("@Localizacion", pLocalizacion);
            ...
            //DataSet dt = new DataSet();
                ...
                return db.ExecuteSelect("Intra_Inventario_Obtener_Marbete_Localizacion_Articulo", Parametros).DataSet;
                //da.Fill(dt);
                //return dt;
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error  al obtener datos del marbete en la localizacion.." + ex.Message.ToString());
                return null;
            }
        }

        /// <summary>
        /// Obtiene las localizaciones de un articulo
        /// </summary>
        /// <param name="pLocalizacion"></param>
        /// <param name="pPIID"></param>
        /// <returns></returns>
        public DataSet ObtenerLocalizacionesArticulo(string pPIID, string pClave)
        {
            //Intra_Inventario_Obtener_Marbete_Localizacion	    
            //@PIID varchar(50),
            //@Localizacion VARCHAR(50)
            ...
            SqlDataAdapter da = new SqlDataAdapter();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "intra_Inventario_ObtenerLocalizacionesArticulo";
            cmd.Parameters.AddWithValue("@PIID", pPIID);
            cmd.Parameters.AddWithValue("@Clave", pClave);
            da.SelectCommand = cmd;
            DataSet dt = new DataSet();
            ...
            {
                MessageBox.Show("Error  al obtener localizaciones del articulo." + ex.Message.ToString());
                return null;
            }
        }
        ...
        public int TotLocalizacionesPorContar(string pPIID, string pIdPareja)
        {
            Dictionary<string, object> Parametros = new Dictionary<string, object>();
            Parametros.Add("@PIID", pPIID);
            Parametros.Add("@IdPareja", pIdPareja);
            DataTable dt = db.ExecuteSelect("inventarioTotLocalizacionesPorContar", Parametros);
            DataRow row = dt.Rows[0];
            return Convert.ToInt16(row[0]);
        }
        //{            
     ...
     public  bool GuardarMarbeteManual(string pClave, string pDesc,string pLoc, 
         ...
         )
      {
        ...
        /// <summary>
        /// Obtiene el numero de marbetes pendientes de primer conteo
        /// </summary>
        /// <param name="pPIID">Inventario</param>
        /// <param name="pIdPareja">Numero de usuario</param>
        /// <returns>Marbetes sin contar</returns>
     public int TotMarbetesPorContar(string pPIID, string pIdPareja)
     {
         Dictionary<string, object> Parametros = new Dictionary<string, object>();
         Parametros.Add("@PIID", pPIID);
         Parametros.Add("@IdPareja", pIdPareja);
         DataTable dt = db.ExecuteSelect("intraInventarioTotMarbetesPorContar", Parametros);
         DataRow row = dt.Rows[0];
         return Convert.ToInt16(row[0]);
     }
        //{                       
     ...
     public int TotMarbetesConDiferencias(string pPIID, string pIdPareja)
     {
         ...
         Parametros.Add("@PIID", pPIID);
         Parametros.Add("@IdPareja", pIdPareja);
         DataTable dt = db.ExecuteSelect("intraInventarioTotMarbetesConDiferencias", Parametros);
         DataRow row = dt.Rows[0];
         return Convert.ToInt16(row[0]);
     }
                        ...
                        if (dt.Tables.Count > 0)
                        {
                            if (dt.Tables[0].Rows.Count > 0)
                            {
                                foreach (DataRow dr in dt.Tables[0].Rows)
                                {
                                    ...
                                    {
                                        if (pConteo1 == 0 && CantTotSistema == 0)
                                        {
                                            CantMarbete = 0;
                                        }
                                        else
                                ...
                                if (!VerificaDiferenciasMarbete(Etiqueta))
                                {
                                    MessageBox.Show("**MARBETE OK**");
                                }
                                else
                                {
                        ...
                        if (dt != null)
                        {
                            if (dt.Tables.Count > 0)
                            {
                                if (dt.Tables[0].Rows.Count > 0)
                                {
                                    ...
                                    {
                                        MessageBox.Show("Los datos se guardaron correctamente, **MARBETE CON DIFERENCIAS**");
                                    }
        ...
        public bool guardar_marbete(string pEtiqueta, string pIdPareja, string pPIID, string pConteo1, string pObservaciones)
        {
            try
            {
                ...
                //MessageBox.Show("Los datos se guardaron correctamente");
                if (!VerificaDiferenciasMarbete(pEtiqueta))
                {
                    MessageBox.Show("**MARBETE OK**");
                }
                else
                {
                    MessageBox.Show("**MARBETE CON DIFERENCIAS**");
                }
        ...
        public void ActualizaContador(int pNumNomina, string pArticulo, string pPIID, string pSiteID, string pLocalizacion)
        {
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "intra_inventario_actualiza_contador";
                cmd.Parameters.AddWithValue("@NumNomina", pNumNomina);
            ...
            {
                MessageBox.Show("Error al actualizar Contador: " + ex.Message.ToString());
            }

        }

        public DataSet SeleccionaMarbeteConDiferenciaAsignado(string pPIID, string pSiteID, int pNumNomina)
        {
            try
            {
                /*
                ...
                DataSet dt = new DataSet();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "intra_inventario_obtener_marbete_diferencias_gral_asignado";
                cmd.Parameters.AddWithValue("@SiteID", pSiteID);
                cmd.Parameters.AddWithValue("@PIID", pPIID);
                cmd.Parameters.AddWithValue("@NumNomina", pNumNomina);
                ...
                if (dt != null)
                {
                    if (dt.Tables.Count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            MessageBox.Show("No hay marbete con diferencias asignado a tu usuario para conteo","Información.");
                            return null;
            ...
            {
                MessageBox.Show("Error al obtener marbete con diferencias asignado para conteo: " + e.Message.ToString(), "Información.");
                return null;
            }
        }

        public DataSet SeleccionaMarbeteConDiferencia(string pPIID, string pSiteID, string pNumNomina)
        {
            try
            {
                /*
                ...
                DataSet dt = new DataSet();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "intra_inventario_obtener_marbete_diferencias_gral";
                cmd.Parameters.AddWithValue("@SiteID", pSiteID);
                cmd.Parameters.AddWithValue("@PIID", pPIID);
                cmd.Parameters.AddWithValue("@NumNomina", pNumNomina);
                ...
                if (dt != null)
                {
                    if (dt.Tables.Count > 0)
                    {
                        ...
                        {
                            MessageBox.Show("No hay marbete con diferencias para conteo.");
                            return null; 
                         }
                    }
                    else
            ...
            {
                MessageBox.Show("Error al obtener marbete con diferencias para conteo" + e.Message.ToString());
                return null; 
            }
        }
        ...
        public bool ObetenerMarbeteConteoDiferencias(out string Etiqueta)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@LocActual", LocActual );
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error al obtener marbete con diferencias para conteo" + ex.Message.ToString());
                Etiqueta = "";
                return false;
            }
        ...
        public bool VerificaDiferenciasMarbete(string pEtiqueta )
        {
            try
            {
                string cad = "";
                cad = "SELECT Diferencias FROM  Intra_Inventario_Maestro WHERE PIID=@PIID AND Etiqueta=@Etiqueta";           
                SqlCommand cmd = new SqlCommand(cad, cn);
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("@PIID", Global.piid );
                cmd.Parameters.AddWithValue("@Etiqueta", pEtiqueta );
                if (cn.State == ConnectionState.Closed)
                {
                    cn.Open();
            ...
            {
                MessageBox.Show("Error al verificar diferencias del marbete" + ex.Message.ToString());               
                return false;
            }
        }
        ...
        public bool ValidaLocalizacionInventarioConDiferencias(string pLocalizacion, string pPIID)
        {
            Dictionary<string, object> Parametros = new Dictionary<string, object>();
            Parametros.Add("@PIID", pPIID);
            Parametros.Add("@Localizacion", pLocalizacion);
            ...
            try
            {
                DataRow row = db.ExecuteSelect("intra_InventarioVerificarLocalizacionConDiferencia", Parametros).Rows[0];
                int tot = Convert.ToInt16(row[0].ToString());
                if (tot>0)
                {
                    return true;
        ...
        public DataSet ObtenerMarbeteLocalizacionConDiferencia(string pLocalizacion, string pPIID, string pCodigo)
        {
            //Intra_Inventario_Obtener_Marbete_Localizacion	    
            //@PIID varchar(50),
            //@Localizacion VARCHAR(50)
            ...
            try
            {
                ...
                Parametros.Add("@Localizacion", pLocalizacion);
                Parametros.Add("@Codigo", pCodigo);
                return db.ExecuteSelect("Intra_Inventario_Obtener_Marbete_Localizacion_Articulo_Con_Diferencias", Parametros).DataSet;
                //da.Fill(dt);
                //return dt;
            }
            catch (Exception ex)
